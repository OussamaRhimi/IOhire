...
The following backlog tables are aligned with the sprint UML use-case and class diagrams. For each story, the table specifies the related UML element and the planned duration in days.
\input{docs/tex/backlog/remaining_sprints_plan.tex}
